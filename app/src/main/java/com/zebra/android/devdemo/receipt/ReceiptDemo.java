...
import com.zebra.android.devdemo.receipt.ConvertToArabic;
...
public class ReceiptDemo extends ConnectionScreen {
    ...
    private String createZplReceipt() {
        ...
        String body = String.format("", headerHeight);
        ...
        String footer = String.format("! 0 200 200 1117 1\n" +
                "PW 574\n" +
                "TONE 25\n" +
                "SPEED 5\n" +
                "ON-FEED IGNORE\n" +
                "NO-PACE\n" +
                "JOURNAL\n" +
                "PCX 200 80 !<IMAGE1.PCX\n" +
                "T 5 0 25 12 03/03/2022\n" +
                "T 5 0 26 39 02:36 PM\n" +
                "T 5 0 410 15 C.Record No#\n" +
                "T 5 0 410 39 Cairo 10724\n" +
                "BT 7 0 0\n" +
                "B 128 1 30 43 160 155 202159491349624\n" +
                "T 7 0 47 280 Trip : 202159491\n" +
                "T 5 0 160 224 Return - Customer copy\n" +
                "T 7 0 407 280 Round :262\n" +
                "T 5 0 32 339 Customer:\n" +
                "T 7 0 32 363 Mohamed Foaad Sakr\n" +
                "T 7 0 379 339 Code : 434454\n" +
                "T 7 0 32 388 Silver 1\n" +
                "T 7 0 32 416 Qaliobya - Anater el Khayeria \n" +
                "T 5 0 32 453 Distributor :\n" +
                "T 7 0 32 478 Hesham Ali\n" +
                "T 7 0 379 453 Code : 024559\n" +
                "T 5 0 30 645 AMOFLUXIN 1 GM 20 TAB\n" +
                "T 7 0 471 645 602338\n" +
                "T 7 0 25 677 36.0\n" +
                "T 7 0 129 677 x1\n" +
                "T 7 0 215 677 45.0\n" +
                "T 7 0 329 677 10/2020\n" +
                "T 7 0 460 677 (RAMED)\n" +
                "T 5 0 28 719 AUGMENTIN 156MG 80ML SUSP\n" +
                "T 7 0 474 719 579983\n" +
                "T 7 0 28 751 31.0\n" +
                "T 7 0 132 751 x1\n" +
                "T 7 0 218 751 39.75\n" +
                "T 7 0 332 751 04/2020\n" +
                "T 7 0 463 751 (MUP)\n" +
                "T 5 0 49 547 Inv. Date:\n" +
                "T 5 0 238 547 Inv. No.\n" +
                "T 5 0 428 547 RTN. No.\n" +
                "T 7 0 49 582 04/01/2021\n" +
                "T 7 0 238 582 2811852\n" +
                "T 7 0 475 582 1\n" +
                "PCX 200 800 !<FRAME.PCX\n" +
                "T 5 0 92 1020 For Any Information Please Call 16017\n" +
                "PRINT\n", footerStartPosition, totalPrice);
        ...
        //Charset.forName("UTF-8").encode(wholeZplLabel);
        String header = String.format(tmpHeader, labelLength, dateString);
//------------------------------------------------------henaaa-----------//

        final String wholeZplLabel = String.format("! 0 200 200 1117 1\n" +
                "ENCODING UTF-8\n" +
                "PW 574\n" +
                "TONE 25\n" +
                "SPEED 5\n" +
                ...
                "T 5 0 25 12 03/03/2022\n" +
                "T 5 0 26 39 02:36 PM\n" +
                "TEXT COURIE01.cpf 0 350 15 " +ConvertToArabic.convertToarab("بطاقة ضريبية رقم") +"\n" +
                "TEXT COURIE01.cpf 0 350 39 " +ConvertToArabic.convertToarab("القاهرة 10724") +"\n" +
                "BT 7 0 0\n" +
                "B 128 1 30 43 160 155 202159491349624\n" +
                "TEXT COURIE01.cpf 0 47 280 " +ConvertToArabic.convertToarab("رحلة : 202159491") +"\n" +
                "TEXT COURIE01.cpf 0 160 224 " +ConvertToArabic.convertToarab("مرتجع - نسخة العميل") +"\n" +
                "TEXT COURIE01.cpf 0 407 280 " +ConvertToArabic.convertToarab("جولة : 262") +"\n" +
                "TEXT COURIE01.cpf 0 32 339 " +ConvertToArabic.convertToarab("العميل") +"\n" +
                "TEXT COURIE01.cpf 0 32 363 " +ConvertToArabic.convertToarab("محمد فؤاد صقر") +"\n" +
                "TEXT COURIE01.cpf 0 379 339 " +ConvertToArabic.convertToarab("كود : 434454") +"\n" +
                "T 7 0 32 388 Silver 1\n" +
                "TEXT COURIE01.cpf 0 32 416 " +ConvertToArabic.convertToarab("القليوبية - القناطر الخيرية") +"\n" +
                "TEXT COURIE01.cpf 0 32 453 " +ConvertToArabic.convertToarab("الموزع") +"\n" +
                "TEXT COURIE01.cpf 0 32 478 " +ConvertToArabic.convertToarab("هشام على") +"\n" +
                "TEXT COURIE01.cpf 0 379 453 " +ConvertToArabic.convertToarab("كود : 024559") +"\n" +
                "T 5 0 30 645 AMOFLUXIN 1 GM 20 TAB\n" +
                "T 7 0 471 645 602338\n" +
                "T 7 0 25 677 36.0\n" +
                "T 7 0 129 677 x1\n" +
                ...
                "T 7 0 475 582 1\n" +
                "PCX 200 800 !<FRAME.PCX\n" +
                "TEXT COURIE01.cpf 0 70 1030 " +ConvertToArabic.convertToarab("للاستفسار برجاء الاتصال على 16017") +"\n" +
                "PRINT\n");
